package com.github.xtorrent.dailytopic.voice.view;
 ...
 */
@TargetApi(16)
public final class AudioExoPlayerView extends FrameLayout {
    ...
    private final AudioExoPlayerView.ComponentListener componentListener;
    ...
    public AudioExoPlayerView(Context context) {
        this(context, null);
    }

    public AudioExoPlayerView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public AudioExoPlayerView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        componentListener = new AudioExoPlayerView.ComponentListener();
